...
{
    public partial class ListenerCreaterView : Form
    {
        private Timer timer;
        private DateTime lastActivityTime;
        private ListenerCreaterController listenerCreaterController;
        public ListenerCreaterView()
        {
            InitializeComponent();
            lastActivityTime = DateTime.Now;
            listenerCreaterController = new ListenerCreaterController(this);
            ShowUser();
            ResetTimer();
            FillComboBox();
        }
        ...
        {
            string[] employment = listenerCreaterController.GetAllEmployment();
            ...
            string[] education = listenerCreaterController.GetAllEducation();
        ...
        {
            listenerCreaterController.ActivityControl(lastActivityTime);
        }
        ...
        {
            timer.Stop();
            listenerCreaterController.ControlNewListener();
            this.Close();
        }
        ...
        {
            listenerCreaterController.CreateListener(new IListener()
            {
        ...
        private void maskedTextBoxBirthday_TextChanged(object sender, EventArgs e)
        {
            ...
            listenerCreaterController.ControlBirthdayDate(maskedTextBoxBirthday.Text);
        }
        ...
        private void maskedTextBoxIssuedDate_TextChanged(object sender, EventArgs e)
        {
            ...
            listenerCreaterController.ControlIssuedDate(maskedTextBoxIssuedDate.Text);
        }
